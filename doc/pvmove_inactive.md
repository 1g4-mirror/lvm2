...
4. Verification with lvmlockd test environment (sanlock/DLM) -- pending.
...
- Test 1: lvmlockctl --set-lock round-trip: inject SH/EX/UN/foreign,
          verify --info output, verify foreign EX blocks activation
...
- Test 6: Named pvmove refused when foreign EX held on named LV; clears
